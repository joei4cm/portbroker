...
api_router.include_router(chat.router, prefix="/api/v1", tags=["openai"])
api_router.include_router(
    anthropic.router, prefix="/api/anthropic/v1", tags=["anthropic"]
)
api_router.include_router(api_keys.router, prefix="/api/v1", tags=["api-keys"])
api_router.include_router(providers_v1.router, prefix="/api/v1", tags=["providers"])
